...
! function(t) {
    ...
    r.define("brand", t.exports = function(t) {
        ...
        return n.ready = function() {
            ...
            /\.webflow\.io$/i.test(p) && c.hostname !== p && (u = !0), u && !s && (e = e || (n = t('<a class="w-webflow-badge"></a>').attr("href", "https://www.mastersubhajit.com"), r = t("<img>").attr("src", "../assets/favicon.svg").attr("alt", "").css({
                marginRight: "8px",
                width: "16px"
